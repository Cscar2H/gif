...
<header class="mdui-appbar mdui-appbar-fixed">
    <div class="mdui-toolbar mdui-color-theme">
        ...
        <a href="https://nowtool.cn" target="_blank" class="mdui-typo-headline mdui-hidden-xs">表情包gif生成</a>
...
<div class="mdui-tab mdui-color-blue-grey" mdui-tab>
    ...
    <?php foreach ($INDEX as $value) : ?>
        <a href="#<?php echo $value['template_name']; ?>" class="mdui-ripple get_value_class"
           onclick="window.location.hash='<?php echo $value['template_name']; ?>'">
    ...
    <div id="<?php echo $value['template_name']; ?>" class="mdui-p-a-2">
        <div class="mdui-panel" mdui-panel>
                    ...
                    <?php for ($i = 0; $i < $value['input_num']; $i++) : ?>
                        <div class="mdui-textfield">
                            ...
                            <input class="mdui-textfield-input" type="text"
                                   name="<?php echo $value['template_name']; ?>_value"
                                   placeholder="<?php echo $value['input_placeholder'][$i]; ?>"/>
                        </div>
                    <?php endfor; ?>
                    ...
                    <?php if (DEFAULT_CREATE_SMALL_GIF === false) : ?>
                        <?php if ($value['small'] == true): ?>
                            <label class="mdui-checkbox">
                                <input id="<?php echo $value['template_name']; ?>-small-size" type="checkbox"
                                       value="true" checked/>
            ...
            <div class="mdui-col">
                ...
                <button class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple" onclick="creat_gif()">生成
                </button>
            </div>
        </div>
    </div>
